...
4. Use critique findings only when the user supplied them in the current task or explicitly named an approved artifact path. Do not discover or depend on hidden prior-run state.
