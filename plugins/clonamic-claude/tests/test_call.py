...
class CallTests(unittest.TestCase):
    ...
    def test_success_is_json_and_redacted(self) -> None:
        ...
        self.assertEqual(
            ...
            "argv=['-p', '--no-session-persistence', '--permission-mode', 'plan', '--tools', '', '--model', 'test-model']",
        )
    ...
    def test_windows_termination_uses_kill_on_close_job(self) -> None:
        spec = importlib.util.spec_from_file_location("clonamic_claude_call", CALL)
