...
PROVIDER = json.loads(r'''{"arguments":["-p","--no-session-persistence","--permission-mode","plan","--tools","","{cli_args}"],"executable":"claude","executor":"clonamic-claude","prompt_transport":"stdin"}''')
