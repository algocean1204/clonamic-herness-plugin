...
PROVIDER = json.loads(r'''{"arguments":["--permission-mode","plan","--disable-web-search","--no-subagents","--tools","","{cli_args}","--prompt-file","{prompt_file}"],"executable":"grok","executor":"clonamic-grok","prompt_transport":"file"}''')
