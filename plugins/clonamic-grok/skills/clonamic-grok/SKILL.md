---
name: clonamic-grok
description: Run one bounded request through the installed Grok CLI when the user explicitly asks to use Grok. Do not use for recursive or cross-executor delegation.
---
